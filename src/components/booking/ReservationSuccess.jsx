  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md mx-auto text-center">
      ...
      <div className="bg-green-50 border border-green-200 rounded-xl p-4 text-left space-y-2 mb-6">
        <p className="text-sm">
          <span className="font-semibold text-gray-600">Mesa(s):</span>{" "}
      ...
      <button onClick={onReset} className="w-full bg-red-600 hover:bg-red-700 text-white font-semibold py-3 rounded-xl transition">
        Volver al inicio
      </button>
    </div>
  );
